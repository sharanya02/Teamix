...
function startMeet () {
  ...
  fetch('https://teamix.herokuapp.com/api/v1/post/meeting/create', requestOptions)
...
function loadTeam () {
  ...
  fetch('https://teamix.herokuapp.com/api/v1/team/details/fetch', requestOptions)
    .then(response => response.json())
    .then(result => {
      console.log(result)
      const { data } = result
...
function enterpost () {
  ...
  fetch('https://teamix.herokuapp.com/api/v1/post/create', requestOptions)
    .then(response => response.json())
    .then(result => {
      console.log(result)
      const { data } = result
...
function deletepost (id) {
  ...
  fetch('https://teamix.herokuapp.com/api/v1/post/delete', requestOptions)
    .then(response => response.json())
    .then(result => {
      console.log(result)
      const { data } = result
